...
public class Controller implements Initializable {
                    ...
                    while (true) {
                        ...
                        if (str.startsWith("/")) {
                            ...
                            if (str.equals("/changeok")) {
                                nickController.addMessage("Смена ника прошла успешно");
                            }
                            if (str.equals("/changeno")) {
                                nickController.addMessage("Смена ника не получилась\n" +
                                        "Возможно предложенные лоин или пароль не верны");
                            }
    ...
    @FXML
    public void showNewNickWindow(ActionEvent actionEvent) {
        nickStage.show();
    }

    private void createNewNickWindow() {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/newnick.fxml"));
            Parent root = fxmlLoader.load();
            nickStage = new Stage();
            nickStage.setTitle("СпэйсЧат Ник");
    ...
    public void tryToChangeNick(String login, String password, String nickname) {
        String msg = String.format("/newnick %s %s %s", login, password, nickname);
